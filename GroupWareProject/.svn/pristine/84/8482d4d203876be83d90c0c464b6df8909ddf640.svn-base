	...
	<div class="d-flex w-100">
		<div class="left-part border-end w-20 flex-shrink-0 d-none d-lg-block">
			...
			<ul class="list-group mh-n100" data-simplebar>
				...
				<li class="fw-semibold text-dark text-uppercase mx-9 my-2 px-3 fs-3" id="pslGrpList">개인 주소록 <a class="align-items-center text-dark py-3 mb-1 rounded-1" href="javascript:void(0)" id="settingBtn">
						<i class="fa-duotone fa-gear fs-5 px-2 rounded-1" >
					</a></i></li>
				<!-- 주소록 그룹을 반복해서 표시 -->
				<c:choose>
					<c:when test="${not empty addressGrpList}">
						<c:forEach var="group" items="${addressGrpList}" varStatus="loop">
							...
							<!-- 그룹 이름과 함께 그룹 링크 생성 -->
							<li class="list-group-item border-0 p-0 mx-9 px-3"><a class="d-flex align-items-center gap-6 list-group-item-action text-dark px-3 py-8 mb-1 rounded-1 group-link" href="javascript:void(0)" data-group-id="adbkGroupNo-${group.adbkGroupNo}" id="group-link-${group.adbkGroupNo}">
									<i class="fa-solid fa-folder fs-4 text-primary" style="color: #FFD43B;"></i> <span class="folder-name">${group.adbkGrpNm}</span>
								</a></li>
		...
		<div class="modal fade" id="addContactModal" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header d-flex align-items-center">
						<h5 class="modal-title" id="addContactTitle">외부사원 주소록 등록</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
							...
							<div class="add-contact-content">
								<form method="post">
									<div class="form-group">
										<label for="c-grpNm" class="me-3">그룹명</label><br/>
					...
					<div class="modal-footer">
						<div class="d-flex gap-6 m-0">
							<button id="btn-siyeon" class="btn btn-warning rounded-pill">시연용 버튼</button>
			...
			<div class="row">
				<div id="pslGrpDiv">
					...
					<div class="col-md-4 col-xl-3">
						...
						</span> <span id="adbkCnt">총 ${not empty addressGrpList ? addressGrpList[0].cnt : '0' }건</span>
					</div>
...
<!-- 									</div> -->
			...
			<div class="row gx-2" id="btnWrapperDiv">
				...
				<div class="col-auto">
					<button type="button" class="btn btn-rounded btn-light" id="shareBtn">채팅방 공유</button>
				</div>
				<div class="col-auto">
					<button type="button" class="btn btn-rounded btn-light" id="ps-modifyBtn">수정</button>
				</div>
				<!-- 				<div class="col-auto"> -->
				<!-- 					<button type="button" class="btn btn-rounded btn-light" id="grpModifyBtn">그룹 이동</button> -->
				<!-- 				</div> -->
				<div class="col-auto">
					<button type="button" class="btn btn-rounded btn-light" id="deleteBtn">삭제</button>
				</div>
				<div class="col-auto">
					<button type="button" class="btn btn-rounded btn-light" id="copyBtn">주소록 복사</button>
				</div>
...
<script type="text/javascript">
	...
	function btnWrapperReset() {
    	...
    	btnHtml += '					<button type="button" class="btn btn-rounded btn-light" id="shareBtn">공유</button>';
    	btnHtml += '				</div>';
    	btnHtml += '				<div class="col-auto">';
    	btnHtml += '					<button type="button" class="btn btn-rounded btn-light" id="ps-modifyBtn">수정</button>';
    	btnHtml += '				</div>';
//     	btnHtml += '				<div class="col-auto">';
//     	btnHtml += '					<button type="button" class="btn btn-rounded btn-light" id="grpModifyBtn">그룹 이동</button>';
//     	btnHtml += '				</div>';
    	btnHtml += '				<div class="col-auto">';
    	btnHtml += '					<button type="button" class="btn btn-rounded btn-light" id="deleteBtn">삭제</button>';
    	btnHtml += '				</div>';
    	btnHtml += '				<div class="col-auto">';
    	btnHtml += '					<button type="button" class="btn btn-rounded btn-light" id="copyBtn">주소록 복사</button>';
    	btnHtml += '				</div>';
