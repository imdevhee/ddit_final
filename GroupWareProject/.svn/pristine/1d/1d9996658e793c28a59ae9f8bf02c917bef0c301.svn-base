		...
		<div class="card rounded-2 bg-primary grid-stack-item-content" style="overflow: hidden;">
			...
			<div class="card-body rounded-3 p-3 text-white">
				...
				<div class="card-body text-center p-3">
					<div class="d-inline">
						<span class="h3 text-white">${employee.emplNm }</span> <span class="ms-2">${employee.clsfNm }</span>
				...
				<div class="">
					...
					<div class="d-flex justify-content-between align-items-center">
						<span>예약 및 대여 현황</span> <span>0</span>
					</div>
					<div class="d-flex justify-content-between align-items-center">
						<span>결재 대기 문서?</span> <span>3</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card grid-stack-item-content">
			...
			<div class="card-body">
				...
				<p class="card-subtitle mb-0 mt-1">
					2024년 4월 5일 (금) <span class="ms-2">16:00</span>
				</p>
				<div class="mt-2">
					<div class="d-flex align-items-center justify-content-between">
						<span class="fw-semibold">출근 시간</span> <span class="">08 : 56</span>
					</div>
					<div class="d-flex align-items-center justify-content-between">
						<span class="fw-semibold">퇴근 시간</span> <span class="text-center me-3">-</span>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="table-responsive">
					<div class="tab-content tabcontent-border p-3" id="myTabContent">
						<div role="tabpanel" class="tab-pane fade show active" id="main-task-gantt" aria-labelledby="main-task-gantt-tab">
							<div id="main-task-gantt-el"></div>
						</div>
						<div class="tab-pane fade" id="main-task-list" role="tabpanel" aria-labelledby="main-task-list-tab">
							<div id="main-task-list-el"></div>
						</div>
						<div class="tab-pane fade" id="main-task-cal" role="tabpanel" aria-labelledby="main-task-cal-tab">
							<div id="main-task-cal-el"></div>
						</div>
					</div>
				</div>
			</div>
								...
								<c:forEach var="newsItem" items="${newsItems}" varStatus="status" begin="0" end="4">
									<p class="fw-semibold mb-1 main-news">
										<a href="${newsItem.link }" target="_blank">
											<i class="fa-light fa-newspaper me-1"></i> <span class="main-news-title" id="main-news-title">${newsItem.title }</span>
										</a>
									</p>
								</c:forEach>
							</c:when>
	...
	<div class="grid-stack-item" gs-x="10" gs-y="0" gs-w="2" gs-h="2" id="A108">
		<div class="card grid-stack-item-content">
			<div class="card-body p-4">
				...
				<div class="d-flex align-items-center justify-content-between">
					<div class="ms-2">
						<span class="display-3"> <i class="ti ti-cloud-rain"></i>
						</span>
					</div>
