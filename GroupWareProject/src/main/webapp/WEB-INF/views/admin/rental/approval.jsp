					...
					<div class="card">
						<div class="card-body">
							<div class="px-9 pt-4 pb-3">
								<a href="/admin/rental/approval">
									<h3 class="fw-semibold mb-4">
										<i class="fa-sharp fa-regular fa-car-side fa-fw fa"></i> 승인대기목록
									</h3>
								</a>
							</div>
...
#ReservListId input[type="search"] {
	margin-right: 10px; /* Adds spacing between the input and the button */
									...
									<div class="d-flex justify-content-start align-items-center my-2">
										...
										<div class="ms-auto">
											<button id="bulkApproveBtn" class="btn btn-primary rounded-0">승인</button>
											<button id="bulkrejectBtn" class="btn btn-danger rounded-0">반려</button>
										</div>
									</div>
